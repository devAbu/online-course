...
export declare type RawBreakpointId = string & {
...
export declare type Breakpoint = LocalBreakpoint | ResolvedBreakpoint;
...
export declare type RemoteObject = StringRemoteObject | NumberRemoteObject | BooleanRemoteObject | SymbolRemoteObject | BigIntRemoteObject | UndefinedRemoteObject | FunctionRemoteObject | ObjectRemoteObject;
...
export declare type EvalResponse = {
    error: false;
    value: RemoteObject;
} | {
    error: true;
...
export declare type GetPropertiesResponse = {
    error: false;
...
declare type TargetDescriptor = PausedTargetDescriptor | RunningTargetDescriptor;
...
declare type EmptyRequestAction<R extends string, F extends string> = EmptyAction<R> | EmptyAction<F>;
...
export declare type PausedRequestedAction = EmptyAction<"pause">;
export interface PausedAction {
    type: "paused";
    callFrames: CallFrame[];
}
export declare type StartAction = EmptyRequestAction<"start", "started">;
export declare type RestartAction = EmptyAction<"restart">;
export declare type StopAction = EmptyRequestAction<"stop", "stopped">;
export declare type ResumeAction = EmptyRequestAction<"resume", "resumed">;
export declare type StepIntoAction = EmptyAction<"stepInto">;
export declare type StepOutAction = EmptyAction<"stepOut">;
export declare type StepOverAction = EmptyAction<"stepOver">;
export declare type FocusUpCallFrameAction = EmptyAction<"focus-up">;
export declare type FocusDownCallFrameAction = EmptyAction<"focus-down">;
...
export declare type Action = TargetConnectedAction | TargetDisconnectedAction | PausedRequestedAction | StartAction | StopAction | RestartAction | PausedAction | ResumeAction | StepIntoAction | StepOutAction | StepOverAction | FocusUpCallFrameAction | FocusDownCallFrameAction | FocusCallFrameAction | AddScriptAction | SetBreakpointAction | VerifyBreakpointAction | RemoveBreakpointRequestAction | RemovedBreakpointAction | SetBreakpointsEnabledRequestAction | SetBreakpointsEnabledAction;
export declare type ActionType = Action["type"];
export declare type ActionByType<T extends ActionType> = Action & {
    type: T;
};
export {};
